...
public class RabbitMQConfig {
    ...
    Queue clienteCadastradoQueue(){
    	return new Queue(FILA_CLIENTE_RESPOSTA);          //fila de retorno com o cliente cadastrado no banco
    }
    ...
    @Bean
    Queue atualizaStatus(){
    	return new Queue(FILA_ATUALIZA_STATUS);    //fila com dados do cliente com erro de cadastro
    }
    								///FILAS CONTA
    @Bean
